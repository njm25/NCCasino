...
/**
 * Phase 0 stub only. Custom chip / name+lore / PDC / mod item integrations are intentionally not implemented yet.
 */
public class CustomChipCurrencyProvider implements CurrencyProvider {
	@Override
	public CurrencyMode getMode() {
		return CurrencyMode.CUSTOM;
	}
