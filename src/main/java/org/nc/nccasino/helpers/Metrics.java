...
public class Metrics {
  ...
  public static class MetricsBase {
    ...
    private void sendData(JsonObjectBuilder.JsonObject data) throws Exception {
      ...
      URL formattedUrl = URI.create(url).toURL(); // Use URI.toURL() instead of new URL(url)
      HttpsURLConnection connection = (HttpsURLConnection) formattedUrl.openConnection();
